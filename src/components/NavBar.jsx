...
import { Navbar, Nav, Container, Badge, Button, NavDropdown, Toast, ToastContainer } from 'react-bootstrap'
    ...
    <>
      ...
      <ToastContainer position="bottom-end" className="p-3" style={{ zIndex: 9999, position: 'fixed' }}>
        <Toast
          ...
          bg="secondary"
        >
          <Toast.Body className="text-white fw-semibold">You've been logged out.</Toast.Body>
        </Toast>
      </ToastContainer>
    </>
  )
